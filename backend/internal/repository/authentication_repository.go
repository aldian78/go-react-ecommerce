...
func NewAuthenticationRepository(db *sql.DB) IAuthenticationRepository {
	return &authenticationRepository{
		db: db,
	}
}

func (ar *authenticationRepository) GetUserByEmail(ctx context.Context, email string) (*entity.User, error) {
...
func (ar *authenticationRepository) InsertUser(ctx context.Context, user *entity.User) error {
...
func (ar *authenticationRepository) UpdateUserPassword(ctx context.Context, userId string, hashedNewPassword string, updatedBy string) error {
	_, err := ar.db.ExecContext(
		ctx,
