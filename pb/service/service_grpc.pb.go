...
func (c *helloWorldServiceClient) HelloWorld(ctx context.Context, in *HelloWorldRequest, opts ...grpc.CallOption) (*HelloWorldResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/service.HelloWorldService/HelloWorld", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloWorldServiceClient) HelloWorld2(ctx context.Context, in *HelloWorldRequest, opts ...grpc.CallOption) (*HelloWorldResponse, error) {
	out := new(HelloWorldResponse)
	err := c.cc.Invoke(ctx, "/service.HelloWorldService/HelloWorld2", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HelloWorldService_HelloWorld2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.HelloWorldService/HelloWorld2",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
